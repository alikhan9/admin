  ...
  return (
    <Page title="User">
      <Container maxWidth="xxl" style={{ height: 1, marginTop:  -50}} >
        ...
        <EditUserForm open={openEdit} handleClose={handleCloseEdit} editRow={editRow} setUsersData={setUsersData} />
        <Card sx={{ width: 1 }}>
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">
                          <UserMoreMenu setUsersData={setUsersData} navigate={navigate} handleOpen={handleOpenEdit} row={row} setEditRow={setEditRow} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
